...
if $no_start; then
    printf "\033[34m* DD_NO_START environment variable set : the newly installed version of the agent will not start by itself. You will have to do it manually using the following command : \n\n $restart_cmd \n  \n\033[0m\n"
    exit
fi
